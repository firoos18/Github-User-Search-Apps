...
class SearchAdapter(private val listUserName : List<String>, private val listUserId : List<Int>, private val avatarUrl : List<String>) : RecyclerView.Adapter<SearchAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder =
        ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.user_item_row, parent, false))
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener{
            Log.d("USERNAME", listUserName[holder.adapterPosition])
